...
class office_equipment:
    ...
    def scud_up(self, quantity):
        try:
            ...
            print('Введены некорректные данные количества поставляемого товара')
        ...
        try:
            if quantity == int(quantity):
                Scud_A().prihod[f'{self.param1} {self.param2} {self.param3}'] = f'\nколичество {quantity}\n' \
                                                                                ...
                                                                                f'Технология устройства  - {self.my_param5}\n'
            else:
                print('Введены некорректные данные количества поставляемого товара')
        except ValueError:
            print('Введены некорректные данные количества поставляемого товара')
...
z = printer('Принтер', 'Pantum', 'P2200', '11.12.2019', 5000, 'A4', 20, 30, 'Лазерный', True).scud_up(10)
x = scanner('Сканер', 'Pantum', 'S2200', '11.03.2008', 3000, 'планшетный', 'CCD', 10).scud_up(20)
